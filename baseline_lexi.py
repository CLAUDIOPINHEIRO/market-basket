# -*- coding: utf-8 -*-
"""
Created on Sat Jun 24 17:05:49 2017
...
# Pickle Dump 
import pickle
os.chdir('C:/Users/alex/Documents/data_transform')
pickle.dump( train_orders, open( "train_orders.p", "wb" ) )
pickle.dump( test_orders, open( "test_orders.p", "wb" ) )
pickle.dump( df_train, open( "df_trains.p", "wb" ) )
pickle.dump( labels, open( "labels.p", "wb" ) )
pickle.dump( orders, open( "orders.p", "wb" ) )
pickle.dump( userXproduct, open( "userXproduct.p", "wb" ) )
